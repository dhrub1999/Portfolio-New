...
const Navbar = () => {
  ...
  return (
    <div className='sticky top-0 z-[40] flex w-full items-center justify-between border-b-2 bg-slate-50 py-8px md:z-20 md:py-12px'>
                ...
                >
                  <motion.li variants={navLi}>
                    <Link href={'/'} prefetch={false}>
                      ...
                      />
                      <p
                        className={`hidden transition-colors duration-200 ease-in hover:text-slate-400 md:block ${
                          pathName === '/'
